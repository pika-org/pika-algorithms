...
pika_algorithms_targets=(
    "foreach_report_test"
    "stream_report_test")
pika_algorithms_test_options=(
...
for executable in "${pika_algorithms_targets[@]}"; do
    test_opts=${pika_algorithms_test_options[$index]}
