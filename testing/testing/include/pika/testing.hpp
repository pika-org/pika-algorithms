...
#define PIKA_TEST_IMPL(fixture, expr)                                          \
    fixture.check_(__FILE__, __LINE__, PIKA_ASSERT_CURRENT_FUNCTION,           \
        ::pika::util::counter_test, expr,                                      \
        "test '" PIKA_PP_STRINGIZE(expr) "'")
...
#define PIKA_TEST_RANGE_(...)                                                  \
    PIKA_PP_EXPAND(PIKA_PP_CAT(PIKA_TEST_RANGE_, PIKA_PP_NARGS(__VA_ARGS__))(  \
        __VA_ARGS__))                                                          \
    /**/
...
#define PIKA_TEST_EQ_MSG_(...)                                                 \
    PIKA_PP_EXPAND(PIKA_PP_CAT(PIKA_TEST_EQ_MSG_, PIKA_PP_NARGS(__VA_ARGS__))( \
        __VA_ARGS__))                                                          \
    /**/
#define PIKA_TEST_EQ_MSG_3(expr1, expr2, msg)                                  \
    PIKA_TEST_EQ_MSG_IMPL(                                                     \
...
#define PIKA_TEST_NEQ_MSG_(...)                                                \
    PIKA_PP_EXPAND(PIKA_PP_CAT(                                                \
        PIKA_TEST_NEQ_MSG_, PIKA_PP_NARGS(__VA_ARGS__))(__VA_ARGS__))          \
    /**/
...
#define PIKA_TEST_LT_MSG_(...)                                                 \
    PIKA_PP_EXPAND(PIKA_PP_CAT(PIKA_TEST_LT_MSG_, PIKA_PP_NARGS(__VA_ARGS__))( \
        __VA_ARGS__))                                                          \
    /**/
#define PIKA_TEST_LT_MSG_3(expr1, expr2, msg)                                  \
    PIKA_TEST_LT_MSG_IMPL(                                                     \
        ::pika::util::detail::global_fixture, expr1, expr2, msg)
...
#define PIKA_TEST_LTE_MSG_(...)                                                \
    PIKA_PP_EXPAND(PIKA_PP_CAT(                                                \
        PIKA_TEST_LTE_MSG_, PIKA_PP_NARGS(__VA_ARGS__))(__VA_ARGS__))          \
    /**/
...
#define PIKA_TEST_RANGE_MSG_(...)                                              \
    PIKA_PP_EXPAND(PIKA_PP_CAT(                                                \
        PIKA_TEST_RANGE_MSG_, PIKA_PP_NARGS(__VA_ARGS__))(__VA_ARGS__))        \
    /**/
...
#define PIKA_SANITY_MSG_(...)                                                  \
    PIKA_PP_EXPAND(PIKA_PP_CAT(PIKA_SANITY_MSG_, PIKA_PP_NARGS(__VA_ARGS__))(  \
        __VA_ARGS__))                                                          \
    /**/
...
#define PIKA_SANITY_NEQ_(...)                                                  \
    PIKA_PP_EXPAND(PIKA_PP_CAT(PIKA_SANITY_NEQ_, PIKA_PP_NARGS(__VA_ARGS__))(  \
        __VA_ARGS__))                                                          \
    /**/
...
#define PIKA_SANITY_LTE_(...)                                                  \
    PIKA_PP_EXPAND(PIKA_PP_CAT(PIKA_SANITY_LTE_, PIKA_PP_NARGS(__VA_ARGS__))(  \
        __VA_ARGS__))                                                          \
    /**/
...
#define PIKA_SANITY_RANGE_(...)                                                \
    PIKA_PP_EXPAND(PIKA_PP_CAT(                                                \
        PIKA_SANITY_RANGE_, PIKA_PP_NARGS(__VA_ARGS__))(__VA_ARGS__))          \
    /**/
...
#define PIKA_SANITY_EQ_MSG_(...)                                               \
    PIKA_PP_EXPAND(PIKA_PP_CAT(                                                \
        PIKA_SANITY_EQ_MSG_, PIKA_PP_NARGS(__VA_ARGS__))(__VA_ARGS__))         \
    /**/
...
#define PIKA_TEST_THROW_(...)                                                  \
    PIKA_PP_EXPAND(PIKA_PP_CAT(PIKA_TEST_THROW_, PIKA_PP_NARGS(__VA_ARGS__))(  \
        __VA_ARGS__))                                                          \
    /**/
