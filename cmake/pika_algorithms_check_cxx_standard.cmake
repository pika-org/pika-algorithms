...
pika_algorithms_option(
  PIKA_ALGORITHMS_WITH_CXX_STANDARD STRING
  "C++ standard to use for compiling pika-algorithms (default: 17)" "17"
  ADVANCED
)

if(PIKA_ALGORITHMS_WITH_CXX_STANDARD LESS 17)
  pika_algorithms_error(
    "You've set PIKA_ALGORITHMS_WITH_CXX_STANDARD to ${PIKA_ALGORITHMS_WITH_CXX_STANDARD}, which is less than 17 which is the minimum required by pika-algorithms"
  )
endif()
...
if(DEFINED CMAKE_CXX_STANDARD AND NOT CMAKE_CXX_STANDARD STREQUAL
  ...
  pika_algorithms_error(
    "You've set CMAKE_CXX_STANDARD to ${CMAKE_CXX_STANDARD} and PIKA_ALGORITHMS_WITH_CXX_STANDARD to ${PIKA_ALGORITHMS_WITH_CXX_STANDARD}. Please unset CMAKE_CXX_STANDARD."
  )
endif()

set(CMAKE_CXX_STANDARD ${PIKA_ALGORITHMS_WITH_CXX_STANDARD})
...
pika_algorithms_info("Using C++${PIKA_ALGORITHMS_WITH_CXX_STANDARD}")
