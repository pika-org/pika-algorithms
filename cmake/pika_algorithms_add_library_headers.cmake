...
function(pika_algorithms_add_library_headers name globtype)
  if(MSVC)
    set(options APPEND)
    set(one_value_args)
...
# ##############################################################################
function(pika_algorithms_add_library_headers_noglob name)
  if(MSVC)
    set(options APPEND)
    set(one_value_args)
    ...
    pika_algorithms_print_list(
      "DEBUG" "pika_algorithms_add_library_sources_noglob.${name}"
    ...
    foreach(header ${headers})
      ...
      if(add_flag)
        pika_algorithms_debug(
          "pika_algorithms_add_library_headers_noglob.${name}"
          "Adding ${absolute_path} to header list for lib${name}"
        )
        set(${name}_HEADERS
            ${${name}_HEADERS} ${absolute_path}
