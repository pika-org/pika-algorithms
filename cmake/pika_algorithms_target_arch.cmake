...
function(pika_algorithms_target_architecture output_var)
  if(APPLE AND CMAKE_OSX_ARCHITECTURES)
    ...
    if(NOT PIKA_ALGORITHMS_INTERNAL_ARCH_DETECT)
      ...
      set(PIKA_ALGORITHMS_INTERNAL_ARCH_DETECT
          ${ARCH}
          CACHE INTERNAL ""
      )
    else()
      set(ARCH ${PIKA_ALGORITHMS_INTERNAL_ARCH_DETECT})
    endif()
  endif()
