...
function(pika_algorithms_add_library_sources name globtype)
  set(options APPEND)
  set(one_value_args)
...
# ##############################################################################
function(pika_algorithms_add_library_sources_noglob name)
  set(options APPEND)
  set(one_value_args)
  ...
  # pika_algorithms_print_list("DEBUG"
  # "pika_algorithms_add_library_sources_noglob.${name}" "Sources for ${name}"
  # ${SOURCES_SOURCES})
