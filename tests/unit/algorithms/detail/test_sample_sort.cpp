...
void test3()
{
    ...
    PIKA_TEST(V1.size() == V2.size());
    for (std::uint32_t i = 0; i < V1.size(); ++i)
    {
        PIKA_TEST(V1[i].num == V2[i].num && V1[i].tail == V2[i].tail);
    }
}
...
void test7()
{
    ...
    PIKA_TEST(B[998] == 0 && B[999] == 0 && B[1000 + NELEM] == 0 &&
        B[1001 + NELEM] == 0);
    ...
    PIKA_TEST(B[998] == 999999999 && B[999] == 999999999 &&
