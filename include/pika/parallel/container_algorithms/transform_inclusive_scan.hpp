...
namespace pika { namespace ranges {
    ...
    ///
    /// \returns  The \a transform_inclusive_scan algorithm returns a
    ///           \a pika::future<transform_inclusive_result<FwdIter1,
    ///           FwdIter2>> if
    ...
    ///
    /// \returns  The \a transform_inclusive_scan algorithm returns a
    ///           \a pika::future<transform_inclusive_scan_result<
...
namespace pika::ranges {
    ...
    private:
        ...
        tag_fallback_invoke(pika::ranges::transform_inclusive_scan_t, Rng&& rng,
